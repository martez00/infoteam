...
if (isset($id) && $id != 0) {
    if (!empty($_POST)) {
        if ($_POST['delete'] == 1) {
            ...
            send_mysqli_query($mysqli,"UPDATE transactions SET assigned_to_other='Ištrintam vartotojui: $_POST[name] $_POST[surname]', type='3', assigned_to_player_id=NULL, assigned_to_user_id=NULL WHERE assigned_to_user_id='$id'");
            ...
            if(is_array($_POST['delete_file']) || is_object($_POST['delete_file'])){
                foreach ($_POST['delete_file'] as $key=>$value){
                    send_mysqli_query($mysqli, "DELETE FROM users_files WHERE id='$key'");
                }
            }
            unset($_POST['id']);
            unset($_POST['delete']);
...
<div>
    <form name="form" id="form" enctype="multipart/form-data" action="<?php echo $_SERVER['PHP_SELF']; ?>"
          method="post">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select name="role_id" id="role_id" form="form"
                                                class="form-control" <?php if (isset($rights['pagrindiniai_duomenys'])) echo $rights['pagrindiniai_duomenys']; ?>><?php if (isset($user_arr)) $role = $user_arr['role_id']; else $role = "0";
                                            echo positions_in_club_list($role, false); ?></select>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <select name="country" id="country" form="form"
                                                class="form-control" <?php if (isset($rights['pagrindiniai_duomenys'])) echo $rights['pagrindiniai_duomenys']; ?>><?php if (isset($user_arr)) $country = $user_arr['country']; else $country = "0";
                                            echo countries_list($country); ?></select>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="form-row">
                                    <div class="col-md-2">
                                        ...
                                        <select name="working" id="working" form="form"
                                                class="form-control" <?php if (isset($rights['pagrindiniai_duomenys'])) echo $rights['pagrindiniai_duomenys']; ?>><?php if (isset($user_arr)) $dirba = $user_arr['working']; else $dirba = "-1";
                                            echo taip_ne_list($dirba, $false, NULL); ?></select>
                                    </div>
                                </div>
                            </div>
                            <?php if (isset($user_arr)) { ?>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        ...
                                        <button onclick="edit_user_note()" type="button" class="btn btn-primary"
