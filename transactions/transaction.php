...
if (isset($id) && $id!=0) {
    ...
    if (!empty($_POST)) {
        ...
        unset($_POST['item_id']);
        $item_arr = $_POST;
        $item_arr['made_by']=$_SESSION['user_id'];
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <?php if($item_exists) {?> <li class="breadcrumb-item active"><?php echo $item_arr['id'];?></li>
                ...
                <div class="card mb-3">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-row">
                                <div class="col-md-2">
                                    ...
                                    <select name="debit_credit" id="debit_credit" form="form"
                                            class="form-control" required><?php echo debet_credit_list($item_arr['debit_credit']); ?></select>
                                </div>
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="type" id="type" form="form"
                                            class="form-control" required><?php echo transaction_assigned_to($item_arr['type']); ?></select>
                                </div>
                                <div class="col-md-2">
                                ...
                                <?php if(isset($item_exists) && $item_arr['type']==2) { ?>
                                 ...
                                 <?php if(isset($item_exists) && $item_arr['type']==3) { ?>
                                     ...
                                     <input type="text" class="form-control" id="assigned_to_other" name="assigned_to_other"
                        ...
                        <?php if(isset($item_arr)) { ?> <a class='btn btn-primary btn-block btn-danger' onclick="document.getElementById('delete').value=1; document.getElementById('saveButton').click();" style="color:white">Trinti pervedimą</a> <?php } ?>
                    </div>
                    <!-- /.content-wrapper -->
                    <div class="modal fade" id="edit_transaction_note" tabindex="-1" role="dialog" aria-labelledby="edit_item_noteLabel" aria-hidden="true">
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button onclick="edit_transaction_note()" type="button" class="btn btn-primary" data-dismiss="modal">Išsaugoti</button>
                                </div>
                            </div>
                        </div>
                    </div>
