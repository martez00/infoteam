...
if (isset($id)) {
    ...
    $players = mfa_kaip_array($mysqli, "SELECT * from players where team_id='$id'");
}
        ...
        <div id="content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                    ...
                    <?php if ($item_exists) { ?>
                        <li class="breadcrumb-item active"><?php echo $item_arr['name'] ?></li>
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <select name="main_team" id="main_team" form="form"
                                            class="form-control"><?php if (isset($item_arr)) $main_team = $item_arr['main_team']; else $main_team = "-1";
                                        echo taip_ne_list($main_team, $false, NULL); ?></select>
                                </div>
                            </div>
                        </div>
                        <?php if (isset($item_arr)) { ?>
                            <div class="form-group space_before_group">
                                <h5><span class="group_name">Komandos žaidėjai</span></h5>
                                <hr>
                            </div>
                            <div class="form-group">
                                <?php
                                if (is_array($players) || is_object($players)) {
                                    echo return_team_players_table($players);
                                } else echo "Šiai komandai nėra priskirtas nei vienas žaidėjas.";
                                ?>
                            </div>
                        <?php } ?>
                        <hr>
                        ...
                        <?php if (isset($item_arr)) {
                            ...
                            ?>  <a class='btn btn-primary btn-block btn-danger'
                                                             ...
                                                             style="color:white">Trinti komandą</a>
                        <?php } else echo "<div class='alert alert-danger text-center' style='margin-top:5px' role='alert'>Komandos ištrinti negalėsite kol jai yra priskirtų žaidėjų!</div>"; } ?>
                    </div>
                </div>
                <!-- /.content-wrapper -->
</form>
