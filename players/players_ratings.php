...
<head>
    ...
    <title>InfoTeam - Žaidėjų reitingai</title>
</head>
    ...
    <div id="content-wrapper">
        ...
        <div class="container-fluid">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Žaidėjų reitingai</li>
            </ol>
            <hr>
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    Žaidėjų reitingai <a onclick="print_table('data_in_table')"><img
                            src="<?php echo $GLOBALS['url_path'] . "images/printer.png"; ?>"></a>
                </div>
                <div class="card-body div_for_responsive_table" id="data_in_table">
                    <?php echo return_players_ratings_table($items, $kiek_viso_irasu, $limit_key, $page); ?>
                </div>
